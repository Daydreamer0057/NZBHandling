...
public class CheckFilmAlreadyDownloadedFile {

    public CheckFilmAlreadyDownloadedFile() {
        ...
        try {
            ...
            File fichierNZB = new File("z://test/film a traiter");
...
//                            System.out.println(fichierNZBTemp.getName()+"    "+nameFilmMain+"    "+year);
                            listTest = new ArrayList<Boolean>();
                            for (String lineTemp : listNamePart) {
                                Pattern p = Pattern.compile("\\b" + lineTemp + "\\b");
                                Matcher m = p.matcher(fichierNZBTemp.getName().toLowerCase());
//                                    System.out.println("matches: " + m.find());

                                if (m.find()) {
                                    if (fichierNZBTemp.getName().contains(year)) {
                                        listTest.add(true);
                                    }
                                }
                            }
...
//                        fichierNZBTemp.delete();
    ...
    public static void main(String... args){
        CheckFilmAlreadyDownloadedFile ch = new CheckFilmAlreadyDownloadedFile();
    }
}
