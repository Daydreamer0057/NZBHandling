...
public class CheckListNzbplanet {
    public CheckListNzbplanet(){
        try{
            ...
            driver.get("https://nzbplanet.net/movies?t=2000&title=&actors=&director=&rating=5&genre=&from=&to=&ob=&offset=&fper_page_nzb=250#results");
            ...
            while (lineSource!=null) {
                ...
                if (lineSource != null) {
                    if (lineSource.toLowerCase().contains("title=\"view movie\"")) {
                        ...
                        String filmSource = null;

                        try {
                            filmSource = getByName(listDoc, movie + " " + yearDoc);
